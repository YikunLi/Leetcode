 ...
 *         original matrix in the same row-traversing order as they were. If the
 *         'reshape' operation with given parameters is possible and legal,
 *         output the new reshaped matrix; Otherwise, output the original
 *         matrix.
 *         Example 1:
 *         Input:
 *         nums = [[1,2], [3,4]]
